...
Object.assign(window, {
    POWER_INFO: {
        [window.PWR_GENERATE_OPS]: {
            className: window.POWER_CLASS.OPERATOR,
            level: [0, 2, 7, 14, 22],
            cooldown: 50,
            effect: [1, 2, 4, 6, 8]
        },
        [window.PWR_OPERATE_SPAWN]: {
            className: window.POWER_CLASS.OPERATOR,
            level: [0, 2, 7, 14, 22],
            cooldown: 300,
            duration: 1000,
    ...
    BODYPARTS_ALL: [
        ...
        window.CARRY,
        window.ATTACK,
        window.RANGED_ATTACK,
        window.TOUGH,
        window.HEAL,
        window.CLAIM
    ],
    RESOURCES_ALL: [
        window.RESOURCE_ENERGY,
        window.RESOURCE_POWER,

        window.RESOURCE_HYDROGEN,
        window.RESOURCE_OXYGEN,
        window.RESOURCE_UTRIUM,
        window.RESOURCE_KEANIUM,
        window.RESOURCE_LEMERGIUM,
        window.RESOURCE_ZYNTHIUM,
        window.RESOURCE_CATALYST,
        window.RESOURCE_GHODIUM,

        window.RESOURCE_HYDROXIDE,
        window.RESOURCE_ZYNTHIUM_KEANITE,
        window.RESOURCE_UTRIUM_LEMERGITE,

        window.RESOURCE_UTRIUM_HYDRIDE,
        window.RESOURCE_UTRIUM_OXIDE,
        window.RESOURCE_KEANIUM_HYDRIDE,
        window.RESOURCE_KEANIUM_OXIDE,
        window.RESOURCE_LEMERGIUM_HYDRIDE,
        window.RESOURCE_LEMERGIUM_OXIDE,
        window.RESOURCE_ZYNTHIUM_HYDRIDE,
        window.RESOURCE_ZYNTHIUM_OXIDE,
        window.RESOURCE_GHODIUM_HYDRIDE,
        window.RESOURCE_GHODIUM_OXIDE,

        window.RESOURCE_UTRIUM_ACID,
        window.RESOURCE_UTRIUM_ALKALIDE,
        window.RESOURCE_KEANIUM_ACID,
        window.RESOURCE_KEANIUM_ALKALIDE,
        window.RESOURCE_LEMERGIUM_ACID,
        window.RESOURCE_LEMERGIUM_ALKALIDE,
        window.RESOURCE_ZYNTHIUM_ACID,
        window.RESOURCE_ZYNTHIUM_ALKALIDE,
        window.RESOURCE_GHODIUM_ACID,
        window.RESOURCE_GHODIUM_ALKALIDE,

        window.RESOURCE_CATALYZED_UTRIUM_ACID,
        window.RESOURCE_CATALYZED_UTRIUM_ALKALIDE,
        window.RESOURCE_CATALYZED_KEANIUM_ACID,
        window.RESOURCE_CATALYZED_KEANIUM_ALKALIDE,
        window.RESOURCE_CATALYZED_LEMERGIUM_ACID,
        window.RESOURCE_CATALYZED_LEMERGIUM_ALKALIDE,
        window.RESOURCE_CATALYZED_ZYNTHIUM_ACID,
        window.RESOURCE_CATALYZED_ZYNTHIUM_ALKALIDE,
        window.RESOURCE_CATALYZED_GHODIUM_ACID,
        window.RESOURCE_CATALYZED_GHODIUM_ALKALIDE,

        window.RESOURCE_OPS,

        window.RESOURCE_SILICON,
        window.RESOURCE_METAL,
        window.RESOURCE_BIOMASS,
        window.RESOURCE_MIST,

        window.RESOURCE_UTRIUM_BAR,
        window.RESOURCE_LEMERGIUM_BAR,
        window.RESOURCE_ZYNTHIUM_BAR,
        window.RESOURCE_KEANIUM_BAR,
        window.RESOURCE_GHODIUM_MELT,
        window.RESOURCE_OXIDANT,
        window.RESOURCE_REDUCTANT,
        window.RESOURCE_PURIFIER,
        window.RESOURCE_BATTERY,
        window.RESOURCE_COMPOSITE,
        window.RESOURCE_CRYSTAL,
        window.RESOURCE_LIQUID,

        window.RESOURCE_WIRE,
        window.RESOURCE_SWITCH,
        window.RESOURCE_TRANSISTOR,
        window.RESOURCE_MICROCHIP,
        window.RESOURCE_CIRCUIT,
        window.RESOURCE_DEVICE,

        window.RESOURCE_CELL,
        window.RESOURCE_PHLEGM,
        window.RESOURCE_TISSUE,
        window.RESOURCE_MUSCLE,
        window.RESOURCE_ORGANOID,
        window.RESOURCE_ORGANISM,

        window.RESOURCE_ALLOY,
        window.RESOURCE_TUBE,
        window.RESOURCE_FIXTURES,
        window.RESOURCE_FRAME,
        window.RESOURCE_HYDRAULICS,
        window.RESOURCE_MACHINE,

        window.RESOURCE_CONDENSATE,
        window.RESOURCE_CONCENTRATE,
        window.RESOURCE_EXTRACT,
        window.RESOURCE_SPIRIT,
        window.RESOURCE_EMANATION,
        window.RESOURCE_ESSENCE
    ],
    COLORS_ALL: [
        window.COLOR_RED,
        window.COLOR_PURPLE,
    ...
    COMMODITIES: {
        [window.RESOURCE_UTRIUM_BAR]: {
            ...
            cooldown: 20,
            components: {
                [window.RESOURCE_UTRIUM]: 500,
                [window.RESOURCE_ENERGY]: 200
            }
        },
        [window.RESOURCE_UTRIUM]: {
            amount: 500,
            cooldown: 20,
            components: {
                [window.RESOURCE_UTRIUM_BAR]: 100,
                [window.RESOURCE_ENERGY]: 200
            }
        },
        [window.RESOURCE_LEMERGIUM_BAR]: {
        ...
        [window.RESOURCE_LEMERGIUM]: {
            ...
            cooldown: 20,
            components: {
                [window.RESOURCE_LEMERGIUM_BAR]: 100,
                [window.RESOURCE_ENERGY]: 200
            }
        },
        [window.RESOURCE_ZYNTHIUM_BAR]: {
        ...
        [window.RESOURCE_ZYNTHIUM]: {
            ...
            cooldown: 20,
            components: {
                [window.RESOURCE_ZYNTHIUM_BAR]: 100,
                [window.RESOURCE_ENERGY]: 200
            }
        },
        [window.RESOURCE_KEANIUM_BAR]: {
        ...
        [window.RESOURCE_KEANIUM]: {
            ...
            cooldown: 20,
            components: {
                [window.RESOURCE_KEANIUM_BAR]: 100,
                [window.RESOURCE_ENERGY]: 200
            }
        },
        [window.RESOURCE_GHODIUM_MELT]: {
        ...
        [window.RESOURCE_GHODIUM]: {
            ...
            cooldown: 20,
            components: {
                [window.RESOURCE_GHODIUM_MELT]: 100,
                [window.RESOURCE_ENERGY]: 200
            }
        },
        [window.RESOURCE_OXIDANT]: {
        ...
        [window.RESOURCE_COMPOSITE]: {
            ...
            cooldown: 50,
            components: {
                [window.RESOURCE_UTRIUM_BAR]: 20,
                [window.RESOURCE_ZYNTHIUM_BAR]: 20,
                [window.RESOURCE_ENERGY]: 20
            }
        },
        [window.RESOURCE_CRYSTAL]: {
            level: 2,
            ...
            cooldown: 21,
            components: {
                [window.RESOURCE_LEMERGIUM_BAR]: 6,
                [window.RESOURCE_KEANIUM_BAR]: 6,
                [window.RESOURCE_PURIFIER]: 6,
                [window.RESOURCE_ENERGY]: 45
            }
        },
        [window.RESOURCE_LIQUID]: {
            level: 3,
            ...
            cooldown: 60,
            components: {
                [window.RESOURCE_OXIDANT]: 12,
                [window.RESOURCE_REDUCTANT]: 12,
                [window.RESOURCE_GHODIUM_MELT]: 12,
                [window.RESOURCE_ENERGY]: 90
            }
        },
        ...
        [window.RESOURCE_WIRE]: {
            ...
            components: {
                [window.RESOURCE_UTRIUM_BAR]: 20,
                [window.RESOURCE_SILICON]: 100,
                [window.RESOURCE_ENERGY]: 40
            }
        },
        [window.RESOURCE_SWITCH]: {
            level: 1,
            ...
            cooldown: 70,
            components: {
                [window.RESOURCE_WIRE]: 40,
                [window.RESOURCE_OXIDANT]: 95,
                [window.RESOURCE_UTRIUM_BAR]: 35,
                [window.RESOURCE_ENERGY]: 20
            }
        },
        [window.RESOURCE_TRANSISTOR]: {
            ...
            cooldown: 59,
            components: {
                [window.RESOURCE_SWITCH]: 4,
                [window.RESOURCE_WIRE]: 15,
                [window.RESOURCE_REDUCTANT]: 85,
                [window.RESOURCE_ENERGY]: 8
            }
        },
        [window.RESOURCE_MICROCHIP]: {
            level: 3,
            ...
            cooldown: 250,
            components: {
                [window.RESOURCE_TRANSISTOR]: 2,
                [window.RESOURCE_COMPOSITE]: 50,
                [window.RESOURCE_WIRE]: 117,
                [window.RESOURCE_PURIFIER]: 25,
                [window.RESOURCE_ENERGY]: 16
            }
        },
        [window.RESOURCE_CIRCUIT]: {
            level: 4,
            ...
            cooldown: 800,
            components: {
                [window.RESOURCE_MICROCHIP]: 1,
                [window.RESOURCE_TRANSISTOR]: 5,
                [window.RESOURCE_SWITCH]: 4,
                [window.RESOURCE_OXIDANT]: 115,
                [window.RESOURCE_ENERGY]: 32
            }
        },
        [window.RESOURCE_DEVICE]: {
            level: 5,
            ...
            cooldown: 600,
            components: {
                [window.RESOURCE_CIRCUIT]: 1,
                [window.RESOURCE_MICROCHIP]: 3,
                [window.RESOURCE_CRYSTAL]: 110,
                [window.RESOURCE_GHODIUM_MELT]: 150,
                [window.RESOURCE_ENERGY]: 64
            }
        },
        ...
        [window.RESOURCE_CELL]: {
            ...
            cooldown: 8,
            components: {
                [window.RESOURCE_LEMERGIUM_BAR]: 20,
                [window.RESOURCE_BIOMASS]: 100,
                [window.RESOURCE_ENERGY]: 40
            }
        },
        [window.RESOURCE_PHLEGM]: {
            ...
            cooldown: 35,
            components: {
                [window.RESOURCE_CELL]: 20,
                [window.RESOURCE_OXIDANT]: 36,
                [window.RESOURCE_LEMERGIUM_BAR]: 16,
                [window.RESOURCE_ENERGY]: 8
            }
        },
        [window.RESOURCE_TISSUE]: {
            ...
            cooldown: 164,
            components: {
                [window.RESOURCE_PHLEGM]: 10,
                [window.RESOURCE_CELL]: 10,
                [window.RESOURCE_REDUCTANT]: 110,
                [window.RESOURCE_ENERGY]: 16
            }
        },
        [window.RESOURCE_MUSCLE]: {
            ...
            cooldown: 250,
            components: {
                [window.RESOURCE_TISSUE]: 3,
                [window.RESOURCE_PHLEGM]: 3,
                [window.RESOURCE_ZYNTHIUM_BAR]: 50,
                [window.RESOURCE_REDUCTANT]: 50,
                [window.RESOURCE_ENERGY]: 16
            }
        },
        [window.RESOURCE_ORGANOID]: {
            ...
            cooldown: 800,
            components: {
                [window.RESOURCE_MUSCLE]: 1,
                [window.RESOURCE_TISSUE]: 5,
                [window.RESOURCE_PURIFIER]: 208,
                [window.RESOURCE_OXIDANT]: 256,
                [window.RESOURCE_ENERGY]: 32
            }
        },
        [window.RESOURCE_ORGANISM]: {
            ...
            cooldown: 600,
            components: {
                [window.RESOURCE_ORGANOID]: 1,
                [window.RESOURCE_LIQUID]: 150,
                [window.RESOURCE_TISSUE]: 6,
                [window.RESOURCE_CELL]: 310,
                [window.RESOURCE_ENERGY]: 64
            }
        },
        ...
        [window.RESOURCE_TUBE]: {
            ...
            cooldown: 45,
            components: {
                [window.RESOURCE_ALLOY]: 40,
                [window.RESOURCE_ZYNTHIUM_BAR]: 16,
                [window.RESOURCE_ENERGY]: 8
            }
        },
        [window.RESOURCE_FIXTURES]: {
            ...
            cooldown: 115,
            components: {
                [window.RESOURCE_COMPOSITE]: 20,
                [window.RESOURCE_ALLOY]: 41,
                [window.RESOURCE_OXIDANT]: 161,
                [window.RESOURCE_ENERGY]: 8
            }
        },
        [window.RESOURCE_FRAME]: {
            ...
            cooldown: 125,
            components: {
                [window.RESOURCE_FIXTURES]: 2,
                [window.RESOURCE_TUBE]: 4,
                [window.RESOURCE_REDUCTANT]: 330,
                [window.RESOURCE_ZYNTHIUM_BAR]: 31,
                [window.RESOURCE_ENERGY]: 16
            }
        },
        [window.RESOURCE_HYDRAULICS]: {
            ...
            components: {
                [window.RESOURCE_LIQUID]: 150,
                [window.RESOURCE_FIXTURES]: 3,
                [window.RESOURCE_TUBE]: 15,
                [window.RESOURCE_PURIFIER]: 208,
                [window.RESOURCE_ENERGY]: 32
            }
        },
        [window.RESOURCE_MACHINE]: {
            ...
            cooldown: 600,
            components: {
                [window.RESOURCE_HYDRAULICS]: 1,
                [window.RESOURCE_FRAME]: 2,
                [window.RESOURCE_FIXTURES]: 3,
                [window.RESOURCE_TUBE]: 12,
                [window.RESOURCE_ENERGY]: 64
            }
        },
        ...
        [window.RESOURCE_CONDENSATE]: {
            ...
            cooldown: 8,
            components: {
                [window.RESOURCE_KEANIUM_BAR]: 20,
                [window.RESOURCE_MIST]: 100,
                [window.RESOURCE_ENERGY]: 40
            }
        },
        [window.RESOURCE_CONCENTRATE]: {
            ...
            cooldown: 41,
            components: {
                [window.RESOURCE_CONDENSATE]: 30,
                [window.RESOURCE_KEANIUM_BAR]: 15,
                [window.RESOURCE_REDUCTANT]: 54,
                [window.RESOURCE_ENERGY]: 12
            }
        },
        [window.RESOURCE_EXTRACT]: {
            level: 2,
            ...
            cooldown: 128,
            components: {
                [window.RESOURCE_CONCENTRATE]: 10,
                [window.RESOURCE_CONDENSATE]: 30,
                [window.RESOURCE_OXIDANT]: 60,
                [window.RESOURCE_ENERGY]: 16
            }
        },
        [window.RESOURCE_SPIRIT]: {
            ...
            cooldown: 200,
            components: {
                [window.RESOURCE_EXTRACT]: 2,
                [window.RESOURCE_CONCENTRATE]: 6,
                [window.RESOURCE_REDUCTANT]: 90,
                [window.RESOURCE_PURIFIER]: 20,
                [window.RESOURCE_ENERGY]: 16
            }
        },
        [window.RESOURCE_EMANATION]: {
            ...
            cooldown: 800,
            components: {
                [window.RESOURCE_SPIRIT]: 2,
                [window.RESOURCE_EXTRACT]: 2,
                [window.RESOURCE_CONCENTRATE]: 3,
                [window.RESOURCE_KEANIUM_BAR]: 112,
                [window.RESOURCE_ENERGY]: 32
            }
        },
        [window.RESOURCE_ESSENCE]: {
            ...
            cooldown: 600,
            components: {
                [window.RESOURCE_EMANATION]: 1,
                [window.RESOURCE_SPIRIT]: 3,
                [window.RESOURCE_CRYSTAL]: 110,
                [window.RESOURCE_GHODIUM_MELT]: 150,
                [window.RESOURCE_ENERGY]: 64
            }
